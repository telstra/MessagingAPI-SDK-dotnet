namespace com.telstra.messaging.Common
{
    public class Constants
    {
        ...
        public static readonly string CLIENT_AUTH_SCOPE = "free-trial-numbers:read free-trial-numbers:write messages:read messages:write virtual-numbers:read virtual-numbers:write reports:read reports:write";
    }
}